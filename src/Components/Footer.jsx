    ...
    return (
            ...
            <footer className="footer items-center p-4 bg-neutral text-neutral-content">
                ...
                <div className='text-white'>
                    <p>Contact:</p>
                    <p>Email: wdshopnil2001@gmail.com</p>
                    <p>what's app:+880 1788398614</p>
                
                </div>
                <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                    <a href=''><img className='w-6 h-6 rounded-full' src="https://i.ibb.co/R6QHVpr/3225191-app-instagram-logo-media-popular-icon.png" alt="" />
                    </a>
                    
                    <a href='https://www.facebook.com/profile.php?id=100009044277654'><img className='w-6 h-6 rounded-full'  src="https://i.ibb.co/jgNDx7n/5296499-fb-facebook-facebook-logo-icon.png" alt="" /></a>
                </nav>
